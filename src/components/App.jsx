...
const dummy = new Recipe('Add Recipe Name', 'Add Description', 'Add Ingredients', 'Add Directions', 'http://img.clipartall.com/download-this-image-as-food-clipart-600_465.png');
